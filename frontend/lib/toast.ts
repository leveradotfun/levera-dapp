...
const KNOWN_REASONS: [RegExp, string][] = [
  ...
  [/not enough idle cash/i, "HFyc cash is still in paired ETH. Run Protect on a stretched coin to free USDG, then redeem."],
  [/peel quietest first/i, "HFyc exits peel the quietest 2x coins first."],
  [/not enough liquidity/i, "Not enough HFyc liquidity in idle cash or quiet 2x pools to cover this exit."],
  ...
  [/leverage off/i, "This coin was launched without 2x and cannot pair against HFyc."],
  [/not more active/i, "HFyc senior only moves from quieter coins toward louder ones."],
  [/already at 2x/i, "This coin is already at its 2x target."],
  [/3ee5aeb5|reentrancyguardreentrantcall/i, "Redeem hit a reentrancy lock while peeling a 2x pool. Redeploy the updated HFyc, then retry."],
