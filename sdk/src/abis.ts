...
export const LAUNCHPAD_FACTORY_ABI = [
  ...
  "function createLaunch(string name, string symbol, uint256 targetRaiseQuote, bool creatorFeeInHfyc, bool leverageEnabled) payable returns (address launch)",
  "function createLaunch(string name, string symbol, uint256 targetRaiseQuote, bool creatorFeeInHfyc, bool leverageEnabled, uint256 creatorBuyIn, uint256 creatorMinTokensOut) payable returns (address launch)",
